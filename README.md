...
*  All 4 gpio pins are intentionally configured as input pins in YAML. This keeps all 4 gpio pins floating at idle, to prevent esp outputs from pulling the wiegand D0 & D1 low causing interruptions that block wiegand reads from both the esp and access control system.
